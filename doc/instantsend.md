...
This mechanism has been integrated into Bitcore-Node-MillenniumClub which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/millenniumclubpay/insight-api-millenniumclub#web-socket-api](https://github.com/millenniumclubpay/insight-api-millenniumclub#web-socket-api)
* API: [https://github.com/millenniumclubpay/insight-api-millenniumclub#instantsend-transactions](https://github.com/millenniumclubpay/insight-api-millenniumclub#instantsend-transactions)
...
By default, the MillenniumClub Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MillenniumClub Core daemon:
