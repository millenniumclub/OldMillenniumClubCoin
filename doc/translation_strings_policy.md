...
This document provides guidelines for internationalization of the MillenniumClub Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `millenniumclub_en.ts` remains unchanged.
