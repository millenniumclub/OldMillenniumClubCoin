...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid millenniumclub address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid millenniumclub address" in e.error['message'])
