...
//! These need to be macros, as clientversion.cpp's and millenniumclub*-res.rc's voodoo requires it
...
/**
 * millenniumclubd-res.rc includes this file, but it cannot cope with real c++ code.
