    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MILL-light"), QVariant("light"));
    ui->theme->addItem(QString("MILL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MILL-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("MILL-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("MILL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MILL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MILL-traditional"), QVariant("trad"));
