    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  millenniumclub-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MillenniumClub in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MILL, 0.1 MILL, 1 MILL and 10 MILL -- sort of like the paper money you use every day.</li> \
