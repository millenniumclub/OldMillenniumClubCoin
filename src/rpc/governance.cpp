...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in millenniumclub.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("millenniumclub.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "millenniumclub",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "millenniumclub",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "millenniumclub",               "gobject",                &gobject,                true,  {} },
    { "millenniumclub",               "voteraw",                &voteraw,                true,  {} },
