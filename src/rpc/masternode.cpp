...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print MillenniumClub address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "millenniumclub",               "masternode",             &masternode,             true,  {} },
    { "millenniumclub",               "masternodelist",         &masternodelist,         true,  {} },
    { "millenniumclub",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "millenniumclub",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "millenniumclub",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "millenniumclub",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
