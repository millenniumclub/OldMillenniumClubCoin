...
2. run millenniumclubd with -printalert or -sendalert like this:
   /path/to/millenniumclubd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.millenniumclub.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MillenniumClub Core:0.12.0.58/"));
