...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          1000},          // 1000 MillenniumClub
    ...
    {SPORK_20_COLLATERAL_CHANGE_FLAG,         4070908800ULL}, // OFF
};

void CSporkManager::ProcessSpork(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    if(fLiteMode) return; // disable all MillenniumClub specific functionality
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_20_COLLATERAL_CHANGE_FLAG")           return SPORK_20_COLLATERAL_CHANGE_FLAG;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_20_COLLATERAL_CHANGE_FLAG:           return "SPORK_20_COLLATERAL_CHANGE_FLAG";
        default:
